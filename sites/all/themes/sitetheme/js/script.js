...
/*
    // Determine how many days until
    function daysUntil(year, month, day) {var now = new Date(),dateEnd = new Date(year, month, day),days = (dateEnd - now) / 1000/60/60/24;return Math.round(days);}
    _date = new Date($('.block_conference-date .content').text());
    _numDays = daysUntil(_date.getFullYear(), _date.getMonth(), _date.getDate());
    $('.block_conference-date .content').text('@'+_numDays+'days');
*/
